...
LOCAL_MODULE_OWNER := leeco
LOCAL_SRC_FILES := proprietary/priv-app/LetvRemoteControl_preinstall/LetvRemoteControl_preinstall.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
...
LOCAL_MODULE_OWNER := leeco
LOCAL_SRC_FILES := proprietary/priv-app/UEIQuicksetSDKLeTV/UEIQuicksetSDKLeTV.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
